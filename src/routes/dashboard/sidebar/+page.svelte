...
<section class="sidebar" class:hide-sidebar="{hideSideBar}">
    ...
    <div class="sidebar-links-container">
      ...
      <a href="" class="btn btn-danger icon-left sidebar-logout-btn"
